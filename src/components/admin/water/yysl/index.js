...
class yysl extends React.Component {
...
<div className="toolbar">
                    ...
                    <div className="UserWaterYyslOut">
                                    ...
                                    <div className="userhandle">
                                        <div className="userhandle-md handleArea">
                                            <div className="userhandle-md-1">
                                                ...
                                                <div className="userhandle-left other">
                                                    <div className='userhandle-col-1'>
                                                        <div className="_info">已缴月数：<span></span></div>
                                                        <div className="_info">已缴合计：<span></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="userhandle-md-1">
                                                ...
                                                <div className="userhandle-right other">
                                                    <div className='userhandle-col-1'>
                                                        <div className="_info">欠费月数：<span></span></div>
                                                        <div className="_info">欠费合计：<span></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
