...
class qfyh extends React.Component {
    constructor() {
        super();
        this.state = {
            startValue: null,
                                    ...
                                    <div className='comIn iptList'>
                                        ...
                                        <div className='iptList-col'>
                                            <div className='iptList-col-1'>
                                                <h3>金额区间：</h3>
                                                <div className="ipt">
                                                    <Input placeholder="金额区间" size="default"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='iptList-col'>
...
export default qfyh;
 ...
 /*<div className="toolbar">
                    ...
                    <div className="UserWaterQfyhOut">
                                ...
                                <div className="cont">
                                    <div className="userhandle">
                                        <div className="userhandle-md handleArea">
                                            ...
                                            <div className="userhandle-md-1" style={{width:'20%'}}>
