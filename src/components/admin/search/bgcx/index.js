...
import { DatePicker , Button , Input , Select , Icon  , Tooltip } from 'antd';

/**表格*/
import TABLE from '../../../../common/components/table';
import TREE from '../../../../common/components/tree';

class bgcx extends React.Component {
...
/*
  <div className="toolbar">
                        <div className="toolbar-md-1">
                            <Button type="primary" icon="search" disabled>高级查询</Button>
                        </div>
                        <div className="toolbar-md-1">
                    ...
                    <div className="UserSearchBgcxOut">
