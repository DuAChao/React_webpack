...
import { Menu , Dropdown , Button , Icon , Input , Select , Tooltip  } from 'antd';
...
class cbdc extends React.Component {
    constructor() {
        super();
        this.state = {
            startValue: null,
    ...
    render() {
        ...
        const menu = (
            <Menu onClick={handleMenuClick} style={{ width: 120 }}>
                <Menu.Item key="1">生成抄表本</Menu.Item>
                <Menu.Item key="2">打印本月抄表册</Menu.Item>
                <Menu.Item key="3">打印抄表页</Menu.Item>
                <SubMenu title="下发抄表设备">
                    <Menu.Item>普表数据</Menu.Item>
                    <Menu.Item>远传表数据</Menu.Item>
                </SubMenu>
                <SubMenu title="用户迁移">
                ...
                <Menu.Item key="4">新增区域</Menu.Item>
            </Menu>
        );
                ...
                <div className="container_out">
                    <div className='LeftContainer'>
                        <div className='commonInner'>
                            ...
                            <div className='chart'>
                                <div className='comIn' ref="lineReact"></div>
                            </div>
                        </div>
                    </div>
...
<div className="toolbar">
                    ...
                    <div className="UserReadingCddcOut">
