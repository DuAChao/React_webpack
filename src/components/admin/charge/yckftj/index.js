...
class yckftj extends React.Component {
                                   ...
                                   <div className='tabLine-col-1'>
                                        ...
                                        <div className='ipt'>
                                            <Select defaultValue="lucy" style={{ width: 100 }} onChange={handleChange}>
                                                <Option value="jack">1003片区</Option>
                                                <Option value="lucy">1004片区</Option>
                                                <Option value="disabled">1008片区</Option>
                                            </Select>
                                        </div>
                                   </div>
                                </div>
