...
class sbcz extends React.Component {
    constructor() {
        super();
        this.state = {
            Loading: false,
    ...
    render() {
        ...
        return (
            <Tooltip placement="top" title='新增水表材质'>
                <div className='tabLine-col' onClick={this.showModal.bind(this)}>
                    <i className="iconfont icon-caizhi" />
                    <Modal 
                    ...
                    >
                        ...
                        <div className="form-col-ipt">
                            ...
                            <div className="ipt">
                                <Input size="large" placeholder="请输入水表材质" />
                            </div>
                        </div>
                    </Modal>
                </div>
